...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-l overflow-y-scroll text-white ${selectedUser ? "max-md:hidden":''}`}>
      <div className='pb-5'>
        ...
        <div className='bg-[#282142] rounded-full flex items items-center gap-2 py-3 px-4 mt-5'>
